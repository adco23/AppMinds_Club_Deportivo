...
object Seeder {
    fun populateIfEmpty(context: Context) {
        ...
        if (!clientDao.hasRecords()) {
            val clientsList = listOf(
                ClientEntity(1, "Juan", "Pérez", "12345678", "juan.perez@email.com", "+54911234567", "Av. Corrientes 1234, CABA", "2024-01-15", true, ClientTypeEnum.SOCIO, ClientStatusEnum.INACTIVO, getCurrentDate()),
                ...
                ClientEntity(3, "Carlos", "Rodríguez", "34567890", "carlos.rodriguez@email.com", "+54911234569", "San Martín 789, Córdoba", "2023-12-10", false, ClientTypeEnum.SOCIO, ClientStatusEnum.INACTIVO, getCurrentDate()),
                ...
                ClientEntity(5, "Luis", "Fernández", "56789012", "luis.fernandez@email.com", "+54911234571", "Belgrano 654, Mendoza", "2023-11-18", true, ClientTypeEnum.SOCIO, ClientStatusEnum.PENDIENTE, getCurrentDate()),
                ...
                ClientEntity(7, "Diego", "Sánchez", "78901234", "diego.sanchez@email.com", "+54911234573", "9 de Julio 147, Tucumán", "2024-02-14", false, ClientTypeEnum.SOCIO, ClientStatusEnum.INACTIVO, getCurrentDate()),
    ...
    private fun getCurrentDate(): Long {
        ...
        return Calendar.getInstance(argentinaTimeZone).apply {
